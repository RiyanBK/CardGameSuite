...
# ALL code in this file generated by Claude with some minor edits for wording
# or spacing's sake made by me.
...
class Rules:
    def __init__(self, app):
        ...
        self.backBtn      = Button('BACK', 100, app.height * 0.05, 80, 36,
                                   rgb(80, 80, 80),   rgb(120, 120, 120))
